<!DOCTYPE html>
    ...
    <body>
        ...
        <main>
            <br>
            <h3 class="many"> === Many More Plasticware Items in Stock === </h3>
            <section class="prod">
                <h1>Plasticware</h1>
            </section>
            <section class="items">
                <?php
                include 'connect.php';
                //Query for the plastics page
                $query = "SELECT * FROM Items where Type like \"Plastic\" Group by Name Order by Name asc";
