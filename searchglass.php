<!DOCTYPE html>
    ...
    <body>
        ...
        <main>
            <br>
            <h3 class="many"> === Many More Glassware Items in Stock === </h3>
            <section class="prod">
                <h1>Glassware</h1>
                <br>
            </section>
            <section class="items">
                <?php
                include 'connect.php';
                //query for all glassware
                $query = "SELECT * FROM Items Where Type like \"%Glassware%\" Group By Name Order by Name asc";
